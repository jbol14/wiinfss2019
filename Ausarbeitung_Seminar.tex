...
\begin{document}
    ...
    %\begin{multicols}{2}
        \section{Einleitung}
            ...
            Der Online-Versandhändler Amazon setzt Data Minig ein um seinen Kunden relevante Artikel zu präsentieren und der Suchmaschinenanbieter Google verwendet Suchanfragen und Nutzungsdaten des Android-Betriebssystems, um personalisierte Werbung zu schalten.\cite{ertel2016}
            ...
            % Dennoch ist eine grundlegende Kenntnis der zur Verfügung stehenden Algorthmen sinnvoll um diese effizient einzusetzen.
             

            % \subsection{Umfang dieser Arbeit}

                %Im Rahmen dieser Arbeit sollen Grundlagen des \emph{Data Mining} und des \emph{maschinellen Lernens} dargelegt werden.\\
            ...
            \subsection{Lernverfahren}
                ...
                \subsubsection{Algorithmus PerzeptronLernen}
                    ...
                    \subsubsection{Beispiel}
                        ...
                        Die Abbildungen \ref{fig:bspPL1}, \ref{fig:bspPL2}, \ref{fig:bspPL3}, \ref{fig:bspPL4} und \ref{fig:bspPL5} veranscheulichen wie eine Anpassung des Gewichtsvektors $w$ die Trennebene beeinflusst.
...
% Ende mein Teil
        ...
        Als Beispiel wird die folgende Ausgangssituation (siehe Abb. \ref{fig:v1}) betrachtet. Zwei Klassen als grüne Plus und rote Minus gekennzeichnet dienen als Menge von Trainingsdaten. Für diese Menge soll nun ein \emph{Voronoi-Diagramm} erstellt werden. \par 
