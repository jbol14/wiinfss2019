    ...
    %\begin{multicols}{2}
        ...
        \section{Maschinelles Lernen}
            ...
            \subsubsection{Der lernende Agent}
                ...
                \begin{Figure}
                   ...
                   \captionof{figure}{lernender Agent \cite{ertel2016}, Seite x, Abildung y}
                \end{Figure}
        ...
        \section{Nearest-Neighbour Lernverfahren}
            ...
            \subsection{Nearest-Neighbour Algorithmus}
                ...
                \begin{Figure}
                    \centering
                    \includegraphics[scale=0.3]{nn2.png}
                    \captionof{figure}{}
                \end{Figure}    
                ...
                \begin{Figure}
                    \centering
                    \includegraphics[scale=0.3]{nn4.png}
                    \captionof{figure}{}
                \end{Figure}        
                
                \begin{Figure}
                    \centering
                    \includegraphics[scale=0.3]{nn5.png}
                    \captionof{figure}{}
                \end{Figure}        
            ...
            \subsection{Kritik an der Nearest-Neighbour Methode}
                ...
                \begin{Figure}
                    \centering
                    \includegraphics[scale=0.3]{errnn1.png}
                    \captionof{figure}{Ausgangssituation}
                \end{Figure}         
                
                \begin{Figure}
                    \centering
                    \includegraphics[scale=0.3]{errnn2.png}
                    \captionof{figure}{}
                \end{Figure}            
        ...
        \section{k-nearest-Neighbour Methode}
            ...
            \subsection{k-nearest Neighbour Algorithmus}
                ...
                \begin{Figure}
                    \centering
                    \includegraphics[scale=0.3]{knn2_b.png}
                    \captionof{figure}{}
                \end{Figure}         
                
                \begin{Figure}
                    \centering
                    \includegraphics[scale=0.3]{knn3.png}
                    \captionof{figure}{}
                \end{Figure}
                
                \begin{Figure}
                    \centering
                    \includegraphics[scale=0.3]{knn4.png}
                    \captionof{figure}{}    
                \end{Figure}        
        ...
        \section{Voronoi-Diagramm Beispiel}
            \begin{Figure}
                \centering
                \includegraphics[scale=0.5]{vor1.png}
                \captionof{figure}{Zu klassifizierende Punkte}
            \end{Figure}
            
            \begin{Figure}
                \centering
                \includegraphics[scale=0.5]{vor2.png}
                \captionof{figure}{Voronoi-Diagramm}
            \end{Figure}            
            
            \begin{Figure}
                \centering
                \includegraphics[scale=0.5]{vor3.png}
