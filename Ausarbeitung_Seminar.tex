...
\begin{document}
    ...
    %\begin{multicols}{2}
        \section{Einleitung}
            ...
            In den vergangenen Jahren hat das \emph{maschinelle Lernen} große Fortschritte gemacht, was im Wesentlichen auf die Zunahme von Reichenleistung und Speicherkapazität zurückgeführt werden kann.\cite{mlfor}
            ...
            Mit zunehmender Bedeutung von \emph{Data Mining} und \emph{maschinellem Lernen} sind auch leicht zu verwendende Frameworks erschienen, die dem Anwender einen leichten Einstieg in die Materie ermöglichen. Zu den bekanntesten Vertretern gehören \emph{Scikit Learn}, ein Framework für die Programmiersprache Python, und \emph{Tensorflow}, ein Framework von Google.
