...
\begin{document}
    ...
    \input{erklaerung_janek.tex}
    \newpage
    \input{erklaerung_steven.tex}
            ...
            \subsection{Nominalskala}
                ...
                \subsection{Lagemaße}
                    ...
                    \subsubsection{Modus}
                        ...
                        $$
                        Aus der Formel folgt direkt, dass das arithmetische Mittel nicht auf nominal- oder ordinalskalierte Merkmale angewendet werden kann, da auf diesen weder Abstand noch Addition definiert sind.
                ...
                \subsection{Zusammenhangsmaße}
                    ...
                    \subsubsection{Korrelationskoeffizient}
                        ...
                        $$
                        Der Korrelationskoeffizient ist normiert auf das Intervall $[-1,1]$, das heißt es gilt $-1 \leq \rho_{xy} \leq 1)$
                        \cite{kohn2005}
